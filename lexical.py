    ...
    def nextTransition(self, state, symbol):
        ...
        if state in self.transitions:
            ...
            if symbol in options:
                next_state = options[symbol]
            elif "ANY" in options:
                next_state = options["ANY"]
            elif "ALPHA" in options and symbol.isalpha():
                next_state = options["ALPHA"]
            elif "DIGIT" in options and symbol.isdigit():
                next_state = options["DIGIT"]
...
fsa_logic_transitions = {0: {"n": 1, "a": 4, "o": 6},
                            1: {"o": 2},
                            2: {"t": 3},
                            4: {"n": 5},
                            5: {"d": 3},
...
fsa_white_space_transitions = {0: {" ": 1, "\t": 1},
                                1: {" ": 1}, "\t": 1}
...
def lexer(tape):
    ...
    while position < len(tape):
        ...
        for machine in machines:
            results.append(runFSA(tape[position:], machine))
